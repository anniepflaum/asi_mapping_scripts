...
from core.constants import DEFAULT_GREEN_ALT_KM, NORMALIZATION_LOWER_PERCENTILE, NORMALIZATION_UPPER_PERCENTILE
...
def series_output_dir(args):
    ...
    folder_name = f"launch_{args.color}_{sites_str}_{args.date}_{start_token}_to_{end_token}_step_{step_token}{green_alt_suffix(args)}"

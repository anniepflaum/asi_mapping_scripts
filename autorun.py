...
def job_pretty():
    ...
    most_recent = sorted(os.listdir('../launch_science_pretty'))[-1]
    os.system(f'scp ../launch_science_pretty/{most_recent} gioptics:/var/www/html/realtime/latest/gneiss_mapped/gneiss_mapped_pretty_latest.png')
